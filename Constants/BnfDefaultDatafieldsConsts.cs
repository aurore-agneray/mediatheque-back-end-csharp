...
public struct BnfDefaultDatafieldsConsts {
    ...
    /// </summary>
    public static BnfDataField _DATA_FIELD_225_1_9 => new BnfDataField() { Tag = "214", Ind1 = "1", Ind2 = "9" };

    /// <summary>
    /// Default Datafield with Tag = "330", Ind1 = " " and Ind2 = " "
    /// </summary>
    public static BnfDataField _DATA_FIELD_330 => new BnfDataField() { Tag = "330" };

    /// <summary>
    /// Default Datafield with Tag = "461", Ind1 = " " and Ind2 = " "
    /// </summary>
    public static BnfDataField _DATA_FIELD_461 => new BnfDataField() { Tag = "461" };

    /// <summary>
    /// Default Datafield with Tag = "700", Ind1 = " " and Ind2 = " "
    /// </summary>
    public static BnfDataField _DATA_FIELD_700 => new BnfDataField() { Tag = "700" };

    /// <summary>
    /// Default Datafield with Tag = "710", Ind1 = " " and Ind2 = " "
    /// </summary>
    public static BnfDataField _DATA_FIELD_710 => new BnfDataField() { Tag = "710" };
}